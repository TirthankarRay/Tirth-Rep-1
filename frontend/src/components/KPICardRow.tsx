...
const KPICardRow: React.FC<KPICardRowProps> = ({ metrics, loading }) => {
  const cards = [
    ...
    },
    {
      ...
      value: metrics?.biomarker_testing_rate != null ? `${metrics.biomarker_testing_rate.toFixed(1)}%` : "--",
    ...
    },
    {
      ...
      value: metrics?.immunotherapy_uptake_rate != null ? `${metrics.immunotherapy_uptake_rate.toFixed(1)}%` : "--",
    ...
    },
    {
      ...
      value: metrics?.clinical_trial_enrollment_rate != null ? `${metrics.clinical_trial_enrollment_rate.toFixed(1)}%` : "--",
